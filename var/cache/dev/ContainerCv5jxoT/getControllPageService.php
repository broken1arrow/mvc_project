 ...
 */
class getControllPageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ControllPage' shared autowired service.
     *
     * @return \App\Controller\ControllPage
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ControllPage.php';

        $container->services['App\\Controller\\ControllPage'] = $instance = new \App\Controller\ControllPage();
        ...
        ]))->withContext('App\\Controller\\ControllPage', $container));
